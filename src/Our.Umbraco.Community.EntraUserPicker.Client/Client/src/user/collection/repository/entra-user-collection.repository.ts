import { EntraUserRepositoryBase } from '../../repository/entra-user-repository-base.js';
...
export class EntraUserCollectionRepository extends EntraUserRepositoryBase implements UmbCollectionRepository {
...
export default EntraUserCollectionRepository;